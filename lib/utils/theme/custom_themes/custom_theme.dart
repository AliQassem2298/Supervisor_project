...
class TTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    titleSmall: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w500, color: Colors.black.withOpacity(0.5)),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    titleSmall: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w500, color: Colors.white.withOpacity(0.5)),
